...
class CsvUtils(object):
    ...
    def make_list(self, sort=False, *values):
        """
    ...
    def _sort(self, reverse=False):
        ...
        self.sorted_copy = sorted(self.container, reverse=reverse,
                                  key=lambda k: k[self.fieldnames[self.sort_criteria]])
        self.sorted = True
    ...
    def sort(self):
        ...
        self.container = sorted(self.container, reverse=self.sort_reversed,
                                key=lambda k: k[self.fieldnames[self.sort_criteria]])
...
if __name__ == '__main__':
    ...
    a = CsvUtils('../../db/resource/industry_dx_rate.csv')
    from common.utils.string_utils import StringUtils as st
    res = st.decode(a.container)
    print (res)
