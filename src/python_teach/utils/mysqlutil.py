...
@author: ljt
'''
from db_config import MYSQL_DATABASE, MYSQL_HOST, MYSQL_PASSWORD, MYSQL_PORT, MYSQL_USER, DB_CHAR
...
class Mysql(object):
    ...
    def __getConn():
        ...
        if Mysql.__pool is None:
            __pool = PooledDB(creator=MySQLdb, mincached=1, maxcached=10000,
                              host=MYSQL_HOST,
                              port=MYSQL_PORT,
                              user=MYSQL_USER,
